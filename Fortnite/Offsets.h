...
DWORD dwForceAttack2 = 0x31FF3CC;
DWORD dwForceBackward = 0x31FF36C;
DWORD dwForceForward = 0x31FF3F0;
DWORD dwForceJump = 0x5278DDC;
DWORD dwForceLeft = 0x31FF378;
DWORD dwForceRight = 0x31FF384;
DWORD dwGameDir = 0x62B880;
DWORD dwGameRulesProxy = 0x52EBE3C;
DWORD dwGetAllClasses = 0xDDD1D4;
DWORD dwGlobalVars = 0x58CCC8;
DWORD dwGlowObjectManager = 0x5317308;
DWORD dwInput = 0x5220480;
DWORD dwInterfaceLinkList = 0x965464;
DWORD dwLocalPlayer = 0xDB35DC;
DWORD dwMouseEnable = 0xDB92E8;
DWORD dwMouseEnablePtr = 0xDB92B8;
DWORD dwPlayerResource = 0x31FD710;
DWORD dwRadarBase = 0x5203C24;
DWORD dwSensitivity = 0xDB9184;
DWORD dwSensitivityPtr = 0xDB9158;
DWORD dwSetClanTag = 0x8A320;
DWORD dwViewMatrix = 0x4DC07C4;
DWORD dwWeaponTable = 0x5220F48;
DWORD dwWeaponTableIndex = 0x326C;
DWORD dwYawPtr = 0xDB8F48;
DWORD dwZoomSensitivityRatioPtr = 0xDBF1B0;
DWORD dwbSendPackets = 0xD9542;
DWORD dwppDirect3DDevice9 = 0xA5050;
DWORD find_hud_element = 0x5B4650F0;
...
DWORD m_pitchClassPtr = 0x5203EC0;
DWORD m_yawClassPtr = 0xDB8F48;
